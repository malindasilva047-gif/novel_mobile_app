...
('Odio público, juego privado', 'odio-publico-juego-privado', 1, 'En el mundo de las carreras, Babe y Charlie son rivales públicos que parecen odiarse con todo su ser. Sin embargo, en privado comparten un secret...', 'story_card_images/story1.jpg', '#DC143C', 3, 1, 1, 'COMPLETED', 4.8, 2305, 50000),
('Echoes of Us: Second Chance Romance 2026', 'echoes-of-us-2026', 1, 'A tale of second chances and unexpected encounters in modern times.', 'story_card_images/story2.jpg', '#E86C9F', 1, 4, 1, 'ONGOING', 4.5, 1800, 35000),
('Scent of Another Alpha', 'scent-of-another-alpha', 1, 'He rejected the mate bond to marry the right omega. Six years later, she''s built an empire from the wreckage — and the scent of her new alpha is...', 'story_card_images/story3.jpg', '#8B4513', 1, 4, 1, 'ONGOING', 5.0, 3200, 75000),
('Conquering My Stepmother & Building My Life', 'conquering-stepmother', 1, 'Kai died an average man and woke up in a brutal world of Cultivators and Immortals. He has no talent, no money, and no background...', 'story_card_images/story4.jpg', '#7B68EE', 2, 5, 1, 'ONGOING', 4.6, 2100, 55000),
('Say You Are Mine', 'say-you-are-mine', 1, 'One night stand. No names. No rules. No regrets. It was supposed to stay that way...', 'story_card_images/story5.jpg', '#E86C9F', 1, 4, 2, 'COMPLETED', 4.9, 2900, 68000),
('The Myth of Sisyphus and his Heirs Vol.3', 'the-myth-of-sisyphus-vol3', 1, 'An unfillable, eternal loneliness...I am a lonely orphan of heart.....She said. Deployed to occupied Japan as a member of the...', 'story_card_images/story6.jpg', '#2F4F4F', 6, 9, 2, 'ONGOING', 4.7, 1950, 42000),
('Heart of Their City (A Why Choose Mafia Romance)', 'heart-of-their-city', 1, 'I''m not afraid of death. Not when I know firsthand there are worse things that can happen to someone who''s still alive.', 'story_card_images/story7.jpg', '#DC143C', 1, 4, 1, 'ONGOING', 4.8, 2450, 58000),
('No Light without Darkness', 'no-light-without-darkness', 1, 'My dear English-speaking readers, I''m a French author and I''m not bilingual. In order to share my novel with you, I''ve used DeepL...', 'story_card_images/story8.jpg', '#FFB6C1', 2, 1, 3, 'ONGOING', 4.6, 1650, 38000),
('If It Means A Lot', 'if-it-means-a-lot', 1, 'Karsh is grieving. After his best friend died, he thought all was lost, that is until he wanders into a mystical bar where...', 'story_card_images/story9.jpg', '#FF8C00', 10, 8, 1, 'ONGOING', 4.4, 1500, 32000),
('Obedience in Ink', 'obedience-in-ink', 1, 'She only wanted to read the story. He made her live it.', 'story_card_images/story10.jpg', '#FF69B4', 1, 4, 2, 'COMPLETED', 5.0, 3100, 72000),
('Casa Bianchi', 'casa-bianchi', 1, 'Teresa is a woman in her late thirties. From the outside, her life looks like many others. From the inside, it is quiet in ways that wear on a person...', 'story_card_images/story11.jpg', '#2F4F4F', 6, 4, 2, 'ONGOING', 4.9, 2800, 64000),
('The Cedar House', 'the-cedar-house', 1, 'Cedar Falls was supposed to be temporary. So was he. Jess returns to her hometown for six weeks — sell the house, close the chapter, leave...', 'story_card_images/story12.jpg', '#E86C9F', 1, 9, 1, 'ONGOING', 4.5, 1900, 44000),
('Faith through famine', 'faith-through-famine', 1, 'Annie O''Roarke has lost everything. Her husband, her home and her family. It is 1847 in Ireland. The great potato famine has overtaken the land...', 'story_card_images/story13.jpg', '#8B4513', 9, 1, 2, 'COMPLETED', 5.0, 2600, 61000),
('Haven House', 'haven-house', 1, 'A gothic mystery about secrets, shadows, and second chances in an old New England manor.', 'story_card_images/story14.jpg', '#2F4F4F', 6, 2, 3, 'ONGOING', 4.7, 2200, 51000),
('The Wild Beyond the Walls', 'the-wild-beyond', 1, 'Five years after the world as she knew it ended, Shara has built a sanctuary in the heart of the jungle — a place untouched by the undead outside...', 'story_card_images/story15.jpg', '#FF8C00', 8, 2, 1, 'ONGOING', 4.6, 1800, 41000);
...
(2, 'Favorite Romances', 'My collection of heart-melting romance stories', 'story_card_images/story5.jpg', 8),
(2, 'Fantasy Adventures', 'Epic quests and magical worlds', 'story_card_images/story4.jpg', 5);
